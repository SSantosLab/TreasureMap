# A tool to extract information from DES Follow-ups to be uploaded to Treasure Map
# Utilize the des20a environment to run

## USAGE:
# S190814bv: python query_tm.py --outfile S190814bv_TM_pointings.csv --start 20190813 --end 20190905 --propid 2019B-0372
